...
/** Generated Interface for ROK_Battle_Plan
 *  @author iDempiere (generated) 
 *  @version Release 2.0
 */
@SuppressWarnings("all")
public interface I_ROK_Battle_Plan 
{

    /** TableName=ROK_Battle_Plan */
    public static final String Table_Name = "ROK_Battle_Plan";
    ...
    /** Column name attack_location */
    public static final String COLUMNNAME_attack_location = "attack_location";
    ...
    public static final String COLUMNNAME_attack_time = "attack_time";
    ...
    /** Column name ROK_Battalion_ID */
    public static final String COLUMNNAME_ROK_Battalion_ID = "ROK_Battalion_ID";
    ...
    /** Column name ROK_Battle_Plan_UU */
    public static final String COLUMNNAME_ROK_Battle_Plan_UU = "ROK_Battle_Plan_UU";
