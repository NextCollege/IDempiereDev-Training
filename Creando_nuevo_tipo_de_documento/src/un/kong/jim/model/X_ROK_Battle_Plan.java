...
/** Generated Model for ROK_Battle_Plan
...
// N
    ...
    {
      StringBuffer sb = new StringBuffer ("X_ROK_Battle_Plan[")
    ...
    {
		return (I_ROK_Battalion)MTable.get(getCtx(), I_ROK_Battalion.Table_Name)
			.getPO(getROK_Battalion_ID(), get_TrxName());	}
	...
	public void setROK_Battalion_ID (int ROK_Battalion_ID)
	{
		if (ROK_Battalion_ID < 1) 
			set_Value (COLUMNNAME_ROK_Battalion_ID, null);
		else 
			set_Value (COLUMNNAME_ROK_Battalion_ID, Integer.valueOf(ROK_Battalion_ID));
	}
